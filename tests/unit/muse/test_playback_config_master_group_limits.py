...
class TestGroupTimeLimit:
    ...
    def test_time_resets_on_group_change(self, app_info_cache):
        app_info_cache.set(GROUP_MAX_MINUTES_KEY, 5)
        master = PlaybackConfigMaster()
