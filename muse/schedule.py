...
class Schedule:
    def __init__(self, name=None, enabled=True, voice="Royston Min", weekday_options=[], start_time=None, end_time=None, shutdown_time=None):
    ...
    def short_text(self):
        return "{0} - {1}".format(self.name, self.voice)
    ...
    def __str__(self):
        ...
        return _("{0} - DJ: {1} - Days: {2} - Times: {3}-{4} - Shutdown: {5}").format(
            self.name, self.voice, weekday_options, 
