...
class SearchWindow(SmartWindow):
    ...
    def __init__(self, master, app_actions, library_data, dimensions="1100x820"):
        ...
        negative_search_hint = _("Comma-separate multiple terms; prefix a term with - to exclude it.")
        ...
        self.all_entry.setToolTip(negative_search_hint)
        ...
        self.title_entry.setToolTip(negative_search_hint)
        ...
        self.album_entry.setToolTip(negative_search_hint)
        ...
        self.artist_entry.setToolTip(negative_search_hint)
        ...
        self.composer_entry.setToolTip(negative_search_hint)
        ...
        self.genre_entry.setToolTip(negative_search_hint)
        ...
        self.instrument_entry.setToolTip(negative_search_hint)
        ...
        self.form_entry.setToolTip(negative_search_hint)
