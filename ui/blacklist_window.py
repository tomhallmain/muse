...
class BlacklistModifyWindow():
    ...
    def __init__(self, master, refresh_callback: Callable, blacklist_item: BlacklistItem, app_actions, dimensions: str = "600x400"):
        ...
        # Done button
        self.done_btn = None
        self.add_btn("done_btn", _("Done"), self.finalize_blacklist_item, row=8, column=0)
...
If you are young, not sure, or even an adult, click the close button on this window now and do something fun instead.""")
    ...
    def setup_blacklist_ui(self):
        ...
        # Add import/export/load default buttons
        ...
        self.add_btn_to(self.header_frame, "add_item_btn", _("Add to blacklist"), self.add_new_item, row=2, column=0)
    ...
    def add_btn_to(self, frame, button_ref_name, text, command, row=0, column=0):
        if getattr(self, button_ref_name) is None:
    ...
    def new_entry(self, frame, text_variable, text="", width=30, **kw):
